...
import base64,sys;exec(base64.b64decode({2:str,3:lambda b:bytes(b,'UTF-8')}[sys.version_info[0]]('')))
import os
def menu():
...
⣿6.Install Hash-Buster-MD5                                                                           ⣿
⣿7.Install ALIENS.HaCK.Camera        						                     ⣿
⣿8.Install WOLF                                                                                      ⣿
⣿99.exit                                                                                             ⣿
⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿
...
while loop:
    ...
    if what =="8":
        ...
        os.system("pkg install git")
        os.system("git clone https://github.com/yehia-hacker/WOLF.git")
        print("====================================")
        print("[+] WOLF installed successfully :)")
        print("[+] Type 'python3 WOLF.py' to start.")
        print("====================================")
        rmenu = input("[?] Back to Menu? (y/n): ")
        if rmenu == "y":
            menu()
